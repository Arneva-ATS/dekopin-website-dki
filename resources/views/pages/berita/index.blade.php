...
<section class="section-box box-content-blog-2">
    <div class="container">
        <div class="text-center blog-head">
            ...
            <span class="btn btn-brand-4-sm">Berita Dekopinwil Jawa Barat</span>
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('https://cmsjabar.rkicoop.co.id/api.php?act=berita&halaman=1')
        ...
        .then(data => {
            ...
            data.forEach(item => {
                ...
                img.src = "https://cmsjabar.rkicoop.co.id/" + item.foto;
                img.alt = item.judul;
