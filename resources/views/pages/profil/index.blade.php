        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="padding-left-auto">
                    ...
                    <h2 class="display-2 mt-15 mb-25 px-2 fw-bold">Dekopinwil Jawa Barat</h2>
                    <p class="text-xl mb-45 px-2">Dekopinwil Jawa Barat bertujuan untuk menjadi pendorong utama dalam memajukan koperasi di wilayah Jawa Barat, serta memberikan kontribusi nyata dalam pembangunan ekonomi yang lebih inklusif dan berkeadilan.</p>
    ...
    <div class="container">
        <div class="row align-items-end">
            <div class="col-lg-6 mb-30">
                <h2 class="heading-2 text-white">Dekopinwil Jawa Barat Berkomitmen untuk Memperkuat Gerakan Koperasi di Wilayah Jawa Barat</h2>
            </div>
            <div class="col-lg-6 mb-30">
                <p class="text-lg text-white fw-normal">Dengan pendekatan yang inklusif dan berkelanjutan, Dekopinwil Jawa Barat berusaha menciptakan ekosistem yang mendukung kesejahteraan anggota koperasi dan masyarakat luas. Melalui kemitraan yang strategis dan program-program yang relevan, Koperasi RKI siap membawa koperasi Indonesia menuju masa depan yang lebih cerah dan berdaya saing global.</p>
            </div>
        </div>
        <div class="row mt-45">
            <div class="col-lg-4">
